...
2. Inspect the target Agent's local transcript format.
...
3. Add config and initialization.
...
6. Add hooks only when reliable.
...
- README examples, default config, skills, CLI choices, and tests all use the same source id.
